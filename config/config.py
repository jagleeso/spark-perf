...
MAX_PARTITIONS_ALL_NODES = NUM_MACHINES * NUM_CORES_PER_MACHINE
MAX_PARTITIONS_1_NODE = NUM_CORES_PER_MACHINE

# NUM_PARTITIONS = MAX_PARTITIONS_ALL_NODES
...
NUM_RECORDS = 200 * 1000 * 1000
assert NUM_RECORDS % int(1/(INPUT_SCALE_DOWN_FACTOR)) == 0
SPARK_KEY_VAL_TEST_OPTS = [
    # The number of input partitions.
    OptionSet("num-partitions", [NUM_PARTITIONS], can_scale=True),
    # The number of reduce tasks.
    OptionSet("reduce-tasks", [NUM_PARTITIONS], can_scale=True),
    ...
    OptionSet("num-records", [NUM_RECORDS * INPUT_SCALE_DOWN_FACTOR], True),
...
NUM_EXAMPLES = 4*1000000
assert NUM_EXAMPLES % int(1/(INPUT_SCALE_DOWN_FACTOR)) == 0
MLLIB_REGRESSION_CLASSIFICATION_TEST_OPTS = MLLIB_COMMON_OPTS + [
    # The number of rows or examples
    OptionSet("num-examples", [NUM_EXAMPLES * INPUT_SCALE_DOWN_FACTOR], can_scale=True)
]
...
MLLIB_CLUSTERING_TEST_OPTS = MLLIB_COMMON_OPTS + [
     ...
     OptionSet("num-points", [1000000000 * INPUT_SCALE_DOWN_FACTOR], can_scale=True),
     OptionSet("num-columns", [3], can_scale=False),
